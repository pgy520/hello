...
global.TEMP_EXTRACT='cn/extract';
...
//设置多语言的子模板
global.renderByLan = function (temp, callback) {
    //拼接模板文件
    var temp2 = temp.split(".html")[0] + "_" + LAN + ".html";
    //检测模板文件是否存在
    var rootPath = path.join(__dirname, '../../');
    var filePath = rootPath + "views/cn/" + temp2;
    fs.exists(filePath, function(exists) {
        ...
        //console.log(LAN, rootPath, filePath, temp2);
        callback && callback(temp2);
    });
}
...
module.exports = function(app){
    ...
    app.use(function (req, res, next) {
        ...
        //语言类别检测
        if (reqLAN && (reqLAN == "cn" || reqLAN == "hk" || reqLAN == "en" || reqLAN == "jp"|| reqLAN == "kr")) {
            global.LAN = reqLAN;
        }
